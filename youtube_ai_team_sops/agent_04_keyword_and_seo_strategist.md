...
Keyword & SEO Strategist is a specialised AI agent responsible for identifies high-volume, low-competition keywords for video titles, descriptions, and tags.. As part of the YouTube AI Dream Team, this agent operates within the **A — Channel Strategy & Ideation** department and plays a critical role in ensuring your channel grows systematically and sustainably.
...
| Attribute | Details |
|---|---|
| **Agent Number** | 04 of 30 |
| **Department** | A — Channel Strategy & Ideation |
| **Primary Role** | Identifies high-volume, low-competition keywords for video titles, descriptions, and tags. |
| **Tools Required** | Google Sheets, TubeBuddy/vidIQ, YouTube Studio |
| **APIs Required** | OpenAI/Anthropic, YouTube Data API v3, SerpAPI |
| **Receives Input From** | Agent 03 (video ideas) |
| **Sends Output To** | Agents 05, 12, 17 |
| **Success KPIs** | Keyword ranking positions, search-driven impressions, CTR from search |
...
- **Video:** [YouTube SEO Basics: How to GET VIEWS with Keyword Research](https://www.youtube.com/watch?v=CUaHe5zzlWs)
- **Creator:** Think Media
- **Key Insight:** This video emphasizes that while keyword tools are a starting point, effective YouTube keyword research involves manual YouTube searches, analyzing top-ranking videos, and using autocomplete for long-tail keywords. It also highlights the importance of creating content related to trending topics to leverage "Suggested Videos" traffic and using YouTube Analytics to verify actual search terms driving views.
...
```
You are the Keyword & SEO Strategist for a YouTube channel in the [NICHE] space.
...
Your role: Identifies high-volume, low-competition keywords for video titles, descriptions, and tags.
...
This is the primary workflow for Keyword & SEO Strategist. Follow these steps in sequence:
...
```
Act as Keyword & SEO Strategist for a YouTube channel about [TOPIC].
...
```
You are a senior Keyword & SEO Strategist with 10 years of YouTube growth experience.
...
```
You are Keyword & SEO Strategist. You have received the following output from the previous agent:
...
**Minimum Required APIs for this agent:** OpenAI/Anthropic, YouTube Data API v3, SerpAPI
...
**Measure success by:** Keyword ranking positions, search-driven impressions, CTR from search
...
This agent is **Agent 04 of 30** in the YouTube AI Dream Team system. The full team covers:

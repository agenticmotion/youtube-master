# Agent 02: Niche & Competitor Analyst
...
Niche & Competitor Analyst is a specialised AI agent responsible for analyses top competitors in the niche to identify content gaps and successful formats.. As part of the YouTube AI Dream Team, this agent operates within the **A — Channel Strategy & Ideation** department and plays a critical role in ensuring your channel grows systematically and sustainably.
...
| Attribute | Details |
|---|---|
| **Agent Number** | 02 of 30 |
| **Department** | A — Channel Strategy & Ideation |
| **Primary Role** | Analyses top competitors in the niche to identify content gaps and successful formats. |
| **Tools Required** | Google Sheets, Apify, YouTube Studio |
| **APIs Required** | OpenAI/Anthropic, YouTube Data API v3, Apify |
| **Receives Input From** | Agent 01 (channel strategy) |
| **Sends Output To** | Agents 03, 04, 05 |
| **Success KPIs** | Content gap opportunities identified, competitor CTR benchmarks, top-performing formats mapped |
...
- **Video:** [How I Analyse Competitors On YouTube (My 3 Step Process)](https://www.youtube.com/watch?v=d4BmWYTNroo)
- **Creator:** Paddy Galloway
- **Key Insight:** This video from Paddy Galloway, a YouTube growth expert, outlines a three-step process for analyzing competitors on YouTube. The process involves identifying successful videos, analyzing their content and strategy, and finding opportunities for your own channel.
...
```
You are the Niche & Competitor Analyst for a YouTube channel in the [NICHE] space.
...
Your role: Analyses top competitors in the niche to identify content gaps and successful formats.
...
This is the primary workflow for Niche & Competitor Analyst. Follow these steps in sequence:
...
```
Act as Niche & Competitor Analyst for a YouTube channel about [TOPIC].
...
```
You are a senior Niche & Competitor Analyst with 10 years of YouTube growth experience.
...
```
You are Niche & Competitor Analyst. You have received the following output from the previous agent:
...
**Minimum Required APIs for this agent:** OpenAI/Anthropic, YouTube Data API v3, Apify
...
**Measure success by:** Content gap opportunities identified, competitor CTR benchmarks, top-performing formats mapped
...
This agent is **Agent 02 of 30** in the YouTube AI Dream Team system. The full team covers:

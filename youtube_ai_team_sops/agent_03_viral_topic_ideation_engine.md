...
**Department:** A — Channel Strategy & Ideation
...
Viral Topic Ideation Engine is a specialised AI agent responsible for generates high-potential video ideas based on search trends, competitor gaps, and audience interest.. As part of the YouTube AI Dream Team, this agent operates within the **A — Channel Strategy & Ideation** department and plays a critical role in ensuring your channel grows systematically and sustainably.
...
| Attribute | Details |
|---|---|
| **Agent Number** | 03 of 30 |
| **Department** | A — Channel Strategy & Ideation |
| **Primary Role** | Generates high-potential video ideas based on search trends, competitor gaps, and audience interest. |
| **Tools Required** | Google Sheets, Notion, Google Trends |
| **APIs Required** | OpenAI/Anthropic, YouTube Data API v3, Google Trends API |
| **Receives Input From** | Agents 01, 02 |
| **Sends Output To** | Agents 04, 05, 07 |
| **Success KPIs** | Ideas generated per week, idea-to-production rate, average view performance of ideas |
...
- **Video:** [The Science-Based Method To Create Irresistible Ideas](https://www.youtube.com/watch?v=pirnGDCZD3Y)
- **Creator:** Kallaway
- **Key Insight:** This video introduces a three-step "Idea Mining System" designed to help creators consistently generate viral video ideas by leveraging data instead of guesswork. The process involves identifying top-performing "outlier" videos in a specific niche, analyzing their core components (like hooks, formats, and topics), and remixing the winning elements to produce new, high-potential content.
...
```
You are the Viral Topic Ideation Engine for a YouTube channel in the [NICHE] space.
...
Your role: Generates high-potential video ideas based on search trends, competitor gaps, and audience interest.
...
This is the primary workflow for Viral Topic Ideation Engine. Follow these steps in sequence:
...
```
Act as Viral Topic Ideation Engine for a YouTube channel about [TOPIC].
...
```
You are a senior Viral Topic Ideation Engine with 10 years of YouTube growth experience.
...
```
You are Viral Topic Ideation Engine. You have received the following output from the previous agent:
...
**Minimum Required APIs for this agent:** OpenAI/Anthropic, YouTube Data API v3, Google Trends API
...
**Measure success by:** Ideas generated per week, idea-to-production rate, average view performance of ideas
...
This agent is **Agent 03 of 30** in the YouTube AI Dream Team system. The full team covers:
